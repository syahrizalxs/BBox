...
export default {
	...
	methods: {
		...
		async getListEvent() {
			...
			const paramAcceptedManager = Object.assign({
			...
			const paramAcceptedDirectors = Object.assign({
				status: 'accepted_direksi'
			})
			...
			const paramRejectedManager = Object.assign({
			...
			const paramRejectedDirectors = Object.assign({
				status: 'rejected_direksi'
			})
			...
			const paramApprovedManager = Object.assign({
			...
			const paramDisapprovedManager = Object.assign({
				status: 'disapproved_manager'
			})
			...
			const paramDisapprovedDirectors = Object.assign({
				status: 'disapproved_direksi'
			})
